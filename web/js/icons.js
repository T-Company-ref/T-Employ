/**
 * Lucide-style inline SVG icons (stroke, 24×24 viewBox).
 * No npm dependency — static web app.
 */
...
const ICONS = {
  ...
  userTie: `<circle cx="12" cy="8" r="4"/><path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M12 11v3"/>`,
  ...
  briefcaseBusiness: `<path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><rect width="20" height="14" x="2" y="6" rx="2"/>`,
  ...
  paperclip: `<path d="m16 6-8.414 8.586a2 2 0 1 0 2.829 2.829l8.414-8.586a4 4 0 1 0-5.657-5.657l-8.379 8.551a6 6 0 1 0 8.485 8.485l8.379-8.551"/>`,
  ...
  fileX: `<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="m9.5 12.5 5 5"/><path d="m14.5 12.5-5 5"/>`,
...
/**
 * @param {string} name
 * @param {{ size?: number, className?: string, title?: string, label?: string }} [opts]
 */
export function icon(name, { size = 16, className = "", title = "", label = "" } = {}) {
  const body = ICONS[name];
  if (!body) return "";
  const cls = ["ui-icon", className].filter(Boolean).join(" ");
  const aria = label || title
    ? `role="img" aria-label="${escAttr(label || title)}"`
    : `aria-hidden="true"`;
  const titleEl = title ? `<title>${escAttr(title)}</title>` : "";
  return `<svg class="${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" ${ATTR} ${aria}>${titleEl}${body}</svg>`;
}
...
/** Section / UI semantic shortcuts */
export const Icon = {
  clipboard: (o) => icon("clipboardList", o),
  phone: (o) => icon("phone", o),
  link: (o) => icon("link", o),
  file: (o) => icon("fileText", o),
  star: (o) => icon("star", o),
  calendar: (o) => icon("calendar", o),
  chart: (o) => icon("barChart", o),
  ban: (o) => icon("ban", o),
  external: (o) => icon("externalLink", o),
  users: (o) => icon("users", o),
  posting: (o) => icon("briefcaseBusiness", o),
  close: (o) => icon("x", o),
  refresh: (o) => icon("refreshCw", o),
  jobkorea: (o) => icon("briefcase", o),
  saramin: (o) => icon("userTie", o),
  platform: (o) => icon("clipboardList", o),
  grid: (o) => icon("layoutGrid", o),
  folder: (o) => icon("folder", o),
  chevron: (o) => icon("chevronDown", o),
  flag: (o) => icon("flag", o),
  list: (o) => icon("list", o),
  search: (o) => icon("search", o),
  dashboard: (o) => icon("layoutDashboard", o),
  school: (o) => icon("graduationCap", o),
  tag: (o) => icon("tag", o),
  paperclip: (o) => icon("paperclip", o),
  mail: (o) => icon("mail", o),
  sliders: (o) => icon("slidersHorizontal", o),
  check: (o) => icon("check", o),
  fileMissing: (o) => icon("fileX", o),
  pin: (o) => icon("pin", o),
  user: (o) => icon("user", o),
};
